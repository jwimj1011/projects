		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Card Title",
									"targetURL": "#CardAppycardmock-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"CardAppycardmock-display": {
								"semanticObject": "CardAppycardmock",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=CardApp.ycardmock",
									"url": sap.ui.require.toUrl("CardApp/ycardmock")
								}
							}
						}
					}
