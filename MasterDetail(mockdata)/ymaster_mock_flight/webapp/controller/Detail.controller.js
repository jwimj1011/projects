sap.ui.define([
	...
	return Controller.extend("MasterDetailApplication.ymastermock.controller.Detail", {
		onInit: function () {
		...
		onSupplierPress: function (oEvent) {
			var supplierPath = oEvent.getSource().getBindingContext("flights").getPath(),
		...
		handleFullScreen: function () {
			...
			this.oRouter.navTo("detail", {layout: sNextLayout, flight: this._flight});
		},
