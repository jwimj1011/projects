		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Master Detail Application Title",
									"targetURL": "#MasterDetailApplicationymastermock-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"MasterDetailApplicationymastermock-display": {
								"semanticObject": "MasterDetailApplicationymastermock",
								"action": "display",
								"description": "A MasterDetail Application.",
								"title": "Master Detail Application Title",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=MasterDetailApplication.ymastermock",
									"url": sap.ui.require.toUrl("MasterDetailApplication/ymastermock")
								}
							}
						}
					}
