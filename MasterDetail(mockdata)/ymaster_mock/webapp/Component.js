    ...
    function (UIComponent, Device, models, JSONModel, fioriLibrary, FlexibleColumnLayoutSemanticHelper) {
        ...
        return UIComponent.extend("MasterDetailApplication.ymastermock.Component", {
            ...
            init: function () {
                ...
                // oProductsModel = new JSONModel(jQuery.sap.getModulePath('MasterDetailApplication/ymaster', '/mockdata/products.json'));
                oProductsModel = new JSONModel(sap.ui.require.toUrl('MasterDetailApplication/ymastermock/mockdata/products.json'));
